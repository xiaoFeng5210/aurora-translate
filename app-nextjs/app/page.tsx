            ...
            <div className="max-w-4xl mx-auto px-4 py-12" data-oid=":7v70nl">
                ...
                <div className="grid gap-8 md:grid-cols-2" data-oid="voeempm">
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center" data-oid="z7278v.">
                            <select
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6" data-oid="4bk1.gy">
                ...
                <div className="mt-12 text-center" data-oid=":w:omwy">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4" data-oid="ynbj:o:">
                        为什么选择我们的AI翻译？
                    </h2>
                    <div className="grid md:grid-cols-3 gap-6 mt-8" data-oid="67:d2zm">
                        <div className="p-6 bg-white rounded-xl shadow-lg" data-oid="r_l90ec">
                            <div
                        ...
                        <div className="p-6 bg-white rounded-xl shadow-lg" data-oid="k.f63s-">
                            <div
                                className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4"
                                data-oid="6ej-svv"
                            >
                        ...
                        <div className="p-6 bg-white rounded-xl shadow-lg" data-oid="tfo_ds1">
                            <div
                                className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4"
                                data-oid="e:go7oy"
                            >
